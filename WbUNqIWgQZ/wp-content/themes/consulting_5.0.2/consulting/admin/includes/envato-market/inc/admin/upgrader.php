...
if ( ! class_exists( 'Envato_Market_Theme_Upgrader' ) ) :
	...
	class Envato_Market_Theme_Upgrader extends Theme_Upgrader {
		...
		public function upgrade_strings() {
			...
			$this->strings['downloading_package'] = __( 'Downloading the Envato Market upgrade package&#8230;', 'consulting' );
		}
		...
		public function install_strings() {
			...
			$this->strings['downloading_package'] = __( 'Downloading the Envato Market install package&#8230;', 'consulting' );
		}
	}
