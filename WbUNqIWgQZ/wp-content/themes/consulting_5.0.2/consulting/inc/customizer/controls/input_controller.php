...
function stm_input( $args = array() ) {
	...
	switch ( $input['type'] ) {
		...
		case 'socials' : ?>
			...
			<input type="hidden" <?php echo consulting_filtered_output($input_props['data']); ?> value="" />
		...
		case 'multiple-checkbox' : ?>
			...
			<input type="hidden" <?php echo consulting_filtered_output($input_props['data']); ?> value="<?php echo esc_attr( implode( ',', $multi_values ) ); ?>" />
